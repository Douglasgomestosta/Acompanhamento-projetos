...
<h3 style="color:white;">Faça Login</h3>

<input type="email" id="email" class="form-control" placeholder="seuemail@email.com" required="" autofocus="" name="email">
  <br>
  <input type="password" id="senha" class="form-control" required="" autofocus="" name="chave" placeholder="Sua senha.">
  <br>
    ...
    if (xhttp.readyState == XMLHttpRequest.DONE) {
        if(xhttp.responseText == "1")
        {
          $("body").fadeOut();
            ...
            document.getElementById("botaocontinuar").innerHTML='Fazer Login';
